...
{
    public partial class Xehoi3Context : DbContext
    {
        public Xehoi3Context()
        {
        }

        public Xehoi3Context(DbContextOptions<Xehoi3Context> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Data Source=KAI\\KAI;Initial Catalog=Xehoi3;Integrated Security=True; Trusted_Connection=True;TrustServerCertificate=True");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Se>(entity =>
            {
                entity.HasKey(e => e.Maxe)
                    .HasName("PK__se__7A209EEBA665B343");
                ...
                entity.Property(e => e.Giathamkhao)
                    .HasColumnType("money")
                    .HasColumnName("giathamkhao");
